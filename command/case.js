      ...
      case "owner":
        {
          ...
          for (let i of ownerContact.map((v) => v + "@s.whatsapp.net")) {
            const vname = aqla.contacts[i] != undefined ? aqla.contacts[i].vname || aqla.contacts[i].notify : undefined;
            ini_list.push({
              displayName: `${ownername}`,
              vcard: `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:${vname}\nitem1.TEL;waid=${i.split("@")[0]}:${i.split("@")[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
            });
          }
          hehe = await aqla.sendMessage(
            from,
            {
          ...
          aqla.sendMessage(from, `Nih Kak Contact Owner Ku, Cuma Sv Nomor Cewe Ya 🤝`, text, { quoted: hehe });
        }
        break;
      case "sticker":
      case "stiker":
